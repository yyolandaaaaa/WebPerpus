    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
                ...
                <div class="sidebar-brand-text mx-3">Yolanda</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('user_input')}}">Tambahkan User</a>
                        <a class="collapse-item" href="{{route('user_all')}}">Tampilkan User</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('tambahbuku')}}">Tambahkan Buku</a>
                        <a class="collapse-item" href="{{route('semuabuku')}}">Tampilkan Buku</a>
                        <div class="collapse-divider"></div>
                    </div>
                </div>
            </li>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePages3" aria-expanded="true"
                ...
                <i class="fas fa-fw fa-folder"></i>
                <span>Page Peminjaman</span>
            </a>
            <div id="collapsePages3" class="collapse" aria-labelledby="headingPages"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('buat_peminjaman')}}">Tambahkan Peminjaman</a>
                    <a class="collapse-item" href="{{route('semua_peminjaman')}}">Tampilkan Peminjaman</a>
                    <div class="collapse-divider"></div>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePages4" aria-expanded="true"
                ...
                <i class="fas fa-fw fa-folder"></i>
                <span>Page Pengembalian</span>
            </a>
            <div id="collapsePages4" class="collapse" aria-labelledby="headingPages"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('buat_pengembalian')}}">Tambahkan Pengembalian</a>
                    <a class="collapse-item" href="{{route('semua_pengembalian')}}">Tampilkan Pengembalian</a>
                    <div class="collapse-divider"></div>
                </div>
            </div>
        </li>
